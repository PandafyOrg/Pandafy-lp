...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      ...
      {/* Decorative elements */}
      <div className="absolute top-20 right-20 h-72 w-72 rounded-full bg-[#60BFA4]/14 blur-3xl" />
      <div className="absolute bottom-20 left-20 h-96 w-96 rounded-full bg-[#C1F277]/16 blur-3xl" />
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#4D6B63]">Junte-se a empresas que escalam com a Etz</p>
        </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-[#0D261F]">
                Confirm Password
              </Label>
              <Input
                id="confirmPassword"
            ...
            <div className="flex items-start space-x-2">
              <input
                type="checkbox"
                id="terms"
                className="mt-1 rounded border-[#D4E6DF] bg-white text-[#1C4259] focus:ring-[#60BFA4]/20"
                required
              />
              <label htmlFor="terms" className="text-sm text-[#4D6B63]">
                I agree to the{" "}
                <Link href="#" className="text-[#1C4259] hover:text-[#60BFA4]">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href="#" className="text-[#1C4259] hover:text-[#60BFA4]">
          ...
          <div className="mt-6 text-center">
            <p className="text-[#4D6B63]">
              ...
              <Link href="/login" className="font-medium text-[#1C4259] hover:text-[#60BFA4]">
                Sign in
              </Link>
            </p>
          </div>
